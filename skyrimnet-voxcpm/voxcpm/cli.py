...
Usage examples:
    ...
    voxcpm --text "Hello world" --prompt-audio voice.wav --prompt-text "reference text" --output output.wav
...
Examples:
  ...
  voxcpm --text "Hello world" --prompt-audio voice.wav --prompt-text "reference text" --output out.wav
